...
export default function AuthPage() {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-background to-muted relative overflow-hidden">
      {/* Theme Toggle */}
      ...
      <div className="flex min-h-screen items-center justify-center p-4 bg-text-dim">
        <div className="w-full max-w-md space-y-6">
          {/* Logo and Header */}
          <div className="text-center">
            <img src={team1Logo} alt="Team1 Logo" className="h-48 mx-auto mb-4" />
          ...
          <Card>
            <CardHeader className="bg-transparent">
              <CardTitle className="text-center">Welcome To Your Project Roster</CardTitle>
